        ...
        ZStack {
            ...
            VStack {
                ...
                List(sampleQueries) { query in
                    ...
                    .listRowBackground(Color("AlfredDarkGray"))  // Set the background of each row
                }
                .listStyle(PlainListStyle())
                .padding(.top, 50)  // Add padding on top of the list
            }
        }
    }
